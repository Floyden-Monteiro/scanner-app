...
namespace Com.Epson.Eposdevice.Printer {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.epson.eposdevice.printer']/interface[@name='ReceiveListener']"
	[Register ("com/epson/eposdevice/printer/ReceiveListener", "", "Com.Epson.Eposdevice.Printer.IReceiveListenerInvoker")]
	public partial interface IReceiveListener : global::Java.Util.IEventListener {
		// Metadata.xml XPath method reference: path="/api/package[@name='com.epson.eposdevice.printer']/interface[@name='ReceiveListener']/method[@name='onPtrReceive' and count(parameter)=6 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='int'] and parameter[4][@type='int'] and parameter[5][@type='int'] and parameter[6][@type='int']]"
		[Register ("onPtrReceive", "(Ljava/lang/String;Ljava/lang/String;IIII)V", "GetOnPtrReceive_Ljava_lang_String_Ljava_lang_String_IIIIHandler:Com.Epson.Eposdevice.Printer.IReceiveListenerInvoker, EpsonBinding")]
		void OnPtrReceive (string? p0, string? p1, int p2, int p3, int p4, int p5);

	}

	[global::Android.Runtime.Register ("com/epson/eposdevice/printer/ReceiveListener", DoNotGenerateAcw=true)]
	internal partial class IReceiveListenerInvoker : global::Java.Lang.Object, IReceiveListener {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/epson/eposdevice/printer/ReceiveListener", typeof (IReceiveListenerInvoker));
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'com.epson.eposdevice.printer.ReceiveListener'.");
			return handle;
		}
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Epson.Eposdevice.Printer.IReceiveListener> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
